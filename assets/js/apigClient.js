...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://cpw2joyvtl.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'Accept', 'key', 'x-amz-meta-customLabels', 'x-api-key', 'bucket'], ['body']);
